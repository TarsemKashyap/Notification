...
{
   public class TPRecurringDdPlanUpdatedEventHandler : IEventHandler<TPRecurringDdPlanUpdatedEvent>
    {
        #region Properties and local variables

        ILog _logger = LogManager.GetLogger(typeof(TPRecurringDdPlanUpdatedEventHandler));
        ...
        public TPRecurringDdPlanUpdatedEventHandler(
        ...
        public void HandleEvent(TPRecurringDdPlanUpdatedEvent eventData)
        {
            using (_logger.Push())
            {
                _logger.Info("Handling event: TPRecurringDdPlanUpdatedEvent", eventData);
                ...
                using (var uow = _storage.NewUnitOfWork())
                {
                    ...
                    Event eventModel = new Event(EventType.RpDdPlanUpdated, DateTime.UtcNow,tpRecurringDDPlan.Merchant.Id, jsonString, "TPRecurringDdPlanUpdatedEventHandler", ContentType.DirectDebitPlan,secret);
